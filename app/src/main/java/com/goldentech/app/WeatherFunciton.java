        ...
        protected void onPostExecute(JSONObject json) {
            try {
                if (json != null) {
                    ...
                    String temperature_min = String.format("%.2f", main.getDouble("temp_min")) + "°";
                    String temperature_max = String.format("%.2f", main.getDouble("temp_max")) + "°";
                    ...
                    main = json.getJSONObject("wind");
                    String wind_speed = main.getString("speed") + " / " + DegreesToCardinal(Double.parseDouble(main.getString("deg"))) + "";

                    delegate.processFinish(city, description, temperature, humidity, pressure, updatedOn, iconText, "" + (json.getJSONObject("sys").getLong("sunrise") * 1000), temperature_min, temperature_max, wind_speed);
